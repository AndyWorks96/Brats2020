...
arch_names = list(vnet3d.__dict__.keys())
...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='vnet3d',
                        choices=arch_names,
                        help='model architecture: ' +
                            ' | '.join(arch_names) +
                            ' (default: NestedUNet)')
    parser.add_argument('--deepsupervision', default=False, type=str2bool)
    parser.add_argument('--dataset', default="AndyWorks",
                        help='dataset name')
...
def main():
    ...
    model = vnet3d.__dict__[args.arch](args)
    model = model.cuda()
